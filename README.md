...
There's also lots of debug proof-cuts ('asserts') left in. Ideally the unnecessary ones would be removed, but they are harmless and finding out which ones are unnecessary