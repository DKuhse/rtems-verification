...
run_one "51_edf_initialize"             /opt/scripts/5.1-active/verify-edf-initialize.sh         "_Scheduler_EDF_Initialize"
run_one "51_edf_node_initialize"        /opt/scripts/5.1-active/verify-edf-node-initialize.sh    "_Scheduler_EDF_Node_initialize"
run_one "51_edf_block"                  /opt/scripts/5.1-active/verify-edf-block.sh              "_Scheduler_EDF_Block"
run_one "51_edf_schedule"               /opt/scripts/5.1-active/verify-edf-schedule.sh           "_Scheduler_EDF_Schedule"
run_one "51_edf_yield"                  /opt/scripts/5.1-active/verify-edf-yield.sh              "_Scheduler_EDF_Yield"
run_one "51_edf_unblock"                /opt/scripts/5.1-active/verify-edf-unblock.sh            "_Scheduler_EDF_Unblock"
run_one "51_edf_update_priority"        /opt/scripts/5.1-active/verify-edf-update-priority.sh    "_Scheduler_EDF_Update_priority"
run_one "51_edf_release_job"            /opt/scripts/5.1-active/verify-edf-release-cancel.sh     "_Scheduler_EDF_Release_job"
run_one "51_edf_cancel_job"             /opt/scripts/5.1-active/verify-edf-release-cancel.sh     "_Scheduler_EDF_Cancel_job"
run_51_heir_helper "51_scheduler_update_heir"  "_Scheduler_Update_heir"
run_one "51_scheduler_release_job"      /opt/scripts/5.1-active/verify-scheduler-release-job.sh    "_Scheduler_Release_job"
run_one "51_scheduler_cancel_job"       /opt/scripts/5.1-active/verify-scheduler-cancel-job.sh     "_Scheduler_Cancel_job"
run_one "51_scheduler_update_priority"  /opt/scripts/5.1-active/verify-scheduler-update-priority.sh "_Scheduler_Update_priority"
run_one "51_thread_priority_add"        /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Thread_Priority_add"
run_one "51_thread_priority_changed"    /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Thread_Priority_changed"
run_one "51_thread_priority_remove"     /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Thread_Priority_remove"
run_one "51_thread_priority_update"     /opt/scripts/5.1-active/verify-thread-priority-update.sh "_Thread_Priority_update"
run_one "51_ratemon_release_job"        /opt/scripts/5.1-active/verify-ratemon-release-job.sh    "_Rate_monotonic_Release_job"
run_one "51_ratemon_cancel"             /opt/scripts/5.1-active/verify-ratemon-cancel.sh         "_Rate_monotonic_Cancel"

# ── RTEMS 5.1 EDF scheduler helpers (each verified once) ────────────────────────
run_one "51_h_edf_get_context"          /opt/scripts/5.1-active/verify-edf-block.sh              "_Scheduler_EDF_Get_context"
run_one "51_h_edf_node_downcast"        /opt/scripts/5.1-active/verify-edf-block.sh              "_Scheduler_EDF_Node_downcast"
run_one "51_h_edf_map_priority"         /opt/scripts/5.1-active/verify-edf-map-unmap.sh          "_Scheduler_EDF_Map_priority"
run_one "51_h_edf_unmap_priority"       /opt/scripts/5.1-active/verify-edf-map-unmap.sh          "_Scheduler_EDF_Unmap_priority"
run_one "51_h_scheduler_get_context"    /opt/scripts/5.1-active/verify-edf-initialize.sh         "_Scheduler_Get_context"
run_one "51_h_rbtree_init_empty"        /opt/scripts/5.1-active/verify-edf-initialize.sh         "_RBTree_Initialize_empty"
run_one "51_h_node_do_initialize"       /opt/scripts/5.1-active/verify-edf-node-initialize.sh    "_Scheduler_Node_do_initialize"
run_one "51_h_rbtree_init_node"         /opt/scripts/5.1-active/verify-edf-node-initialize.sh    "_RBTree_Initialize_node"
run_one "51_h_edf_schedule_body"        /opt/scripts/5.1-active/verify-edf-schedule.sh           "_Scheduler_EDF_Schedule_body"
run_one "51_h_edf_extract_body"         /opt/scripts/5.1-active/verify-edf-schedule.sh           "_Scheduler_EDF_Extract_body"
run_one "51_h_thread_is_ready"          /opt/scripts/5.1-active/verify-edf-update-priority.sh    "_Thread_Is_ready"
run_one "51_h_scheduler_node_get_prio"  /opt/scripts/5.1-active/verify-edf-update-priority.sh    "_Scheduler_Node_get_priority"
run_one "51_h_thread_get_priority"      /opt/scripts/5.1-active/verify-edf-unblock.sh            "_Thread_Get_priority"
run_one "51_h_thread_sched_home_node"   /opt/scripts/5.1-active/verify-edf-unblock.sh            "_Thread_Scheduler_get_home_node"
run_one "51_h_priority_get_priority"    /opt/scripts/5.1-active/verify-edf-unblock.sh            "_Priority_Get_priority"
run_51_heir_helper "51_h_thread_get_cpu" "_Thread_Get_CPU"

# ── RTEMS 5.1 priority helpers (verify-thread-change-priority.sh) ───────────────
run_one "51_h_priority_actions_add"          /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Priority_Actions_add"
run_one "51_h_priority_non_empty_insert"     /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Priority_Non_empty_insert"
run_one "51_h_priority_extract_non_empty"    /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Priority_Extract_non_empty"
run_one "51_h_priority_changed"              /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Priority_Changed"
run_one "51_h_thread_set_sched_node_prio"    /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Thread_Set_scheduler_node_priority"
run_one "51_h_thread_priority_action_change" /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Thread_Priority_action_change"
run_one "51_h_thread_queue_do_nothing_pa"    /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Thread_queue_Do_nothing_priority_actions"
run_one "51_h_thread_priority_do_perform"    /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Thread_Priority_do_perform_actions"
run_one "51_h_thread_priority_apply"         /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Thread_Priority_apply"
run_one "51_h_scheduler_node_set_priority"   /opt/scripts/5.1-active/verify-thread-change-priority.sh "_Scheduler_Node_set_priority"
