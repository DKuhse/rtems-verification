#!/bin/bash
#
# Temporarily isolate _Thread_Get_priority() from the RTEMS 6.2 active port.
#
# Usage:
#   tmp-verify-thread-get-priority.sh
#   tmp-verify-thread-get-priority.sh --gui
#
set -e
...
SRC="${OVERLAY}/harnesses/thread-get-priority-harness.c"
